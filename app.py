...
def oil_effect(decode_array_to_img):
	...
	#is a function of opencv which is used to convert an img to an oil painting, 1. is the variable which holds the img, 2. is the size of pixel on the img,3. 1= white balancing 
